...
Route::get('public_journal','publicJournalController@index');//Journal
Route::get('public_journal/{id?}/Volumes','publicJournalController@Volumes');//Volumes
Route::get('Volume/{id?}/issues','publicJournalController@issues');//issues
Route::get('file/{id?}/list','publicJournalController@file');//paper
Route::resource('BARD_journal','JournalController');//fahmida poly
Route::resource('volume','VolController');//Shamanur
Route::resource('issue','IssueController');//shima
Route::resource('file','FileController');//lina
...
Route::get('/infos', 'TrainersController@index_info');
