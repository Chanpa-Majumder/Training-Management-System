    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-calendar"></i> <span>Journal</span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class=""><a href="{{ URL::to('/BARD_journal/create') }}"><i class="fa fa-circle-o"></i> Create Journal</a></li>
                        <li class=""><a href="{{ URL::to('/BARD_journal') }}"><i class="fa fa-circle-o"></i> All Journal</a></li>
...
--}}{{--                        <li class=""><a href="{{ URL::to('/listOfstudentsAndMarks') }}"><i class="fa fa-circle-o"></i> All Trainee Course</a></li>--}}{{--
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <span>Trainings</span><span class="label label-primary pull-right"></span><i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li class=" treeview">
                            <a href="#">
                                <i class="fa fa-files-o"></i>
                                <span>Testimonial</span><span class="label label-primary pull-right"></span><i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class=" treeview">
                            <a href="#">
                                <i class="fa fa-files-o"></i>
                                <span>FAQs</span><span class="label label-primary pull-right"></span><i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
