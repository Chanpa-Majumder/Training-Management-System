        ...
        <div class="well well bs-component">
            ...
            <form class="form-horizontal" action="{!! action('AttendanceController@updateAttendance') !!}" method="post">
                ...
                <div class="row">
				   <div class="col-md-12">
				        <div class="col-md-4">
                        <label for="inputTrainingName" class="control-label">Course Name: {{ $course_name }}</label>
                        
                            <input type="hidden" value="{{ $course_id }}" name="course_id">
                       
                    </div>
					<div class="col-md-4">
                        <label for="inputTrainingName" class="control-label">Session: {{ $session }}</label>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-lg-offset-0" align="right">
